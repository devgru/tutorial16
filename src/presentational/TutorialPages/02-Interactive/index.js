  ...
  <Page inverse>
    <div className="Tutorial-text">
      ...
      <p>
        ...
        интерактивных элементов, позволяющий изучать, сравнивать и оценивать цвета.
      </p>
      <p>
      ...
      <p>
        ...
        <Delta c1="#FF0" c2="#00F" />. Оно объясняется и используется в блоке «Цветовые схемы».
      </p>
      <p>
        Наборы цветов изображены на трёхмерных визуализациях в контексте цветовых моделей. Каждую можно покрутить курсором или пальцем. Попробуйте:
      </p>
    </div>
